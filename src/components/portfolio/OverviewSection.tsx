            ...
            <div className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="space-y-3 md:space-y-4 border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      Dedicated Full Stack Developer with international remote
                      experience, skilled in designing cloud-based solutions
                      with Docker, developing backend services using Node and
                      Express, writing clean and efficient TypeScript and Go
                      code, and building scalable e-commerce and SaaS platforms
                      with secure payment systems. Committed to delivering
                      seamless user experiences and continuously growing through
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-green-600 dark:text-green-400 font-medium text-sm md:text-base">
                        Junior Web Developer And Instructor
                      </p>
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">
                        Jul 2024 – Dec 2024
                      </p>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Designed and developed 50+ responsive client websites using
                    WordPress Delivered ongoing maintenance and updates to
                    ensure site performance, security, and reliability Mentored
                    25+ students in web development and WordPress
                  </p>
                </motion.div>
              </div>
            </div>
